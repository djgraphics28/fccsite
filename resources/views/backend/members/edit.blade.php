                    ...
                    <form action="{{ route('members.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-lg" id="isFirstTime" name="isFirstTime">
                                ...
                                <option {{ $member->is_first_time == 1 ? 'selected' : '' }} value="1">Yes</option>
                                <option {{ $member->is_first_time == 0 ? 'selected' : '' }} value="0">No</option>
                            </select>
                            @error('gender')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date"
                                ...
                                name="birthDate" value="{{ $member->birth_date ?? '' }}">
                            @error('birthDate')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
